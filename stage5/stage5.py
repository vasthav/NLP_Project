...
def createParts(reviews_list):
    """Creates 10 parts of the review list for Training and Validation

    Arguments:
        reviews_list {List} -- [List of all the reviews]

    Returns:
        [list of list] -- [break the list of review into list of 10 lists]
    """
    reviews = [[], [], [], [], [], [], [], [], [], []]
